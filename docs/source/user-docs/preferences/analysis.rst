...
Clutter will use the underlying Rizin analysis options to analyze a binary. These options are usually 
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Clutter will check if there is a candidate for a new function following an already defined one, as the compiler usually
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
When encountering unconditional jumps during the analysis, Clutter will add a code-reference even if it is not guaranteed
...
This can help Clutter to continue the analysis to target of the ``jmp``.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
When enabled, Clutter will print warnings it encountered while preforming analysis. These warnings can help the user
