...
Butter = the Cutter GUI you know, renamed and hardened, shipped as a **zero-install
...
```
butter/                       (this repo)
├─ src/ cmake/ dist/ scripts/ docs/ docker/    the Butter fork of Cutter (upstream)
...
* The Butter fork of Cutter: **GPL-3** (see `COPYING`) — as upstream.
