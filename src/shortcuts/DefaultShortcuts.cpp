    ...
    static const QHash<QString, Shortcut> defaultShortcuts = {
        ...
        { "General.zoomIn",
          { { Qt::CTRL | Qt::Key_Plus, Qt::CTRL | Qt::SHIFT | Qt::Key_Plus },
            QT_TRANSLATE_NOOP("ClutterGraphView", "Zoom In"),
            "ClutterGraphView" } },
        { "General.zoomOut",
          { { Qt::CTRL | Qt::Key_Minus },
            QT_TRANSLATE_NOOP("ClutterGraphView", "Zoom Out"),
            "ClutterGraphView" } },
        { "General.zoomReset",
          { { Qt::CTRL | Qt::Key_Equal },
            QT_TRANSLATE_NOOP("ClutterGraphView", "Reset Zoom"),
            "ClutterGraphView" } },
        { "General.addComment",
          { { Qt::Key_Semicolon },
        ...
        { "Search.toggle",
          { { QKeySequence::keyBindings(QKeySequence::Find) },
            QT_TRANSLATE_NOOP("ClutterSearchable", "Toggle Search Bar"),
            "ClutterSearchable" } },
        { "Search.findNext",
          { { Qt::Key_Return },
        ...
        { "Docking.toggle",
          { { Qt::Key_Alt },
            QT_TRANSLATE_NOOP("ClutterDockWidget", "Enable/Disable Docking"),
            "ClutterDockWidget" } },
