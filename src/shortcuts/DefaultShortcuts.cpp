    ...
    static const QHash<QString, Shortcut> defaultShortcuts = {
        ...
        { "General.zoomIn",
          { { Qt::CTRL | Qt::Key_Plus, Qt::CTRL | Qt::SHIFT | Qt::Key_Plus },
            QT_TRANSLATE_NOOP("ButterGraphView", "Zoom In"),
            "ButterGraphView" } },
        { "General.zoomOut",
          { { Qt::CTRL | Qt::Key_Minus },
            QT_TRANSLATE_NOOP("ButterGraphView", "Zoom Out"),
            "ButterGraphView" } },
        { "General.zoomReset",
          { { Qt::CTRL | Qt::Key_Equal },
            QT_TRANSLATE_NOOP("ButterGraphView", "Reset Zoom"),
            "ButterGraphView" } },
        { "General.addComment",
          { { Qt::Key_Semicolon },
        ...
        { "Search.toggle",
          { { QKeySequence::keyBindings(QKeySequence::Find) },
            QT_TRANSLATE_NOOP("ButterSearchable", "Toggle Search Bar"),
            "ButterSearchable" } },
        { "Search.findNext",
          { { Qt::Key_Return },
        ...
        { "Docking.toggle",
          { { Qt::Key_Alt },
            QT_TRANSLATE_NOOP("ButterDockWidget", "Enable/Disable Docking"),
            "ButterDockWidget" } },
