#ifndef CLUTTER_GRAPHVIEW_H
#define CLUTTER_GRAPHVIEW_H
...
/**
 * @brief Common Clutter specific graph functionality.
 */
class ClutterGraphView : public GraphView
{
    Q_OBJECT
public:
    ClutterGraphView(QWidget *parent);
