#ifndef BUTTER_GRAPHVIEW_H
#define BUTTER_GRAPHVIEW_H
...
/**
 * @brief Common Butter specific graph functionality.
 */
class ButterGraphView : public GraphView
{
    Q_OBJECT
public:
    ButterGraphView(QWidget *parent);
