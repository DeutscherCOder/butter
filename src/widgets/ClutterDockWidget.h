#ifndef CLUTTERWIDGET_H
#define CLUTTERWIDGET_H
...
/**
 * @brief QDockWidget wrapper for Clutter
 *
 * This should serve as a base class for all dock widgets in main window
 */
class CLUTTER_EXPORT ClutterDockWidget : public QDockWidget
{
    Q_OBJECT

public:
    CLUTTER_DEPRECATED("Action will be ignored. Use ClutterDockWidget(MainWindow*) instead.")
    ClutterDockWidget(MainWindow *parent, QAction *action);

    explicit ClutterDockWidget(MainWindow *parent);
    ~ClutterDockWidget() override;
     ...
     * @see ClutterDockWidget#deserializeViewProperties
     */
     ...
     * @see ClutterDockWidget#serializeViewProprties
     */
