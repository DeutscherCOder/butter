#ifndef CLUTTERPLUGIN_H
#define CLUTTERPLUGIN_H
...
/**
 * @brief Interface for defining any Clutter plugin
 */
class CLUTTER_EXPORT ClutterPlugin
{
public:
    virtual ~ClutterPlugin() = default;
     ...
     *
     * called after Clutter's core UI has been initialized
     */
     ...
     *
     * called during initialization of Clutter, after setupPlugin()
     */
...
#define ClutterPlugin_iid "re.rizin.clutter.plugins.ClutterPlugin"

Q_DECLARE_INTERFACE(ClutterPlugin, ClutterPlugin_iid)

#endif // CLUTTERPLUGIN_H
