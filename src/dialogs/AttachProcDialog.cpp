      ...
      timer(new QTimer(this))
{
    ...
    connect(allView, &QAbstractItemView::doubleClicked, this,
            &AttachProcDialog::onAllProcViewDoubleClicked);
    connect(smallView, &QAbstractItemView::doubleClicked, this,
            &AttachProcDialog::onProcBeingAnalyzedViewDoubleClicked);

    connect(ui->buttonBox, &QDialogButtonBox::accepted, this,
            &AttachProcDialog::onButtonBoxAccepted);
    connect(ui->buttonBox, &QDialogButtonBox::rejected, this,
            &AttachProcDialog::onButtonBoxRejected);
}
