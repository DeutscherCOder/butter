...
// Global information for Butter
#define APPNAME "Butter"
...
#ifdef BUTTER_SOURCE_BUILD
#    define BUTTER_EXPORT Q_DECL_EXPORT
#else
#    define BUTTER_EXPORT Q_DECL_IMPORT
#endif

#if defined(__has_cpp_attribute)
#    if __has_cpp_attribute(deprecated)
#        define BUTTER_DEPRECATED(msg) [[deprecated(msg)]]
#    endif
#endif
#if !defined(BUTTER_DEPRECATED)
#    define BUTTER_DEPRECATED(msg)
#endif
