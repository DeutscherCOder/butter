...
void ButterSearchableHelper::setupConnections(QWidget *parent, SearchBarWidget *searchBar)
{
    auto *searchable = dynamic_cast<ButterSearchableI *>(parent);
...
void ButterSearchableHelper::positionSearchBar(QWidget *parent, SearchBarWidget *searchBar,
