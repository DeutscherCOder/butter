#ifndef CLUTTERSEARCHABLE_H
#define CLUTTERSEARCHABLE_H
 ...
 */
class ClutterSearchableI
{
public:
    virtual ~ClutterSearchableI() = default;
 ...
 */
namespace ClutterSearchableHelper {
