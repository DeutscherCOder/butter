#ifndef BUTTERSEARCHABLE_H
#define BUTTERSEARCHABLE_H
 ...
 */
class ButterSearchableI
{
public:
    virtual ~ButterSearchableI() = default;
 ...
 */
namespace ButterSearchableHelper {
