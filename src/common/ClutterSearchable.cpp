...
void ClutterSearchableHelper::setupConnections(QWidget *parent, SearchBarWidget *searchBar)
{
    auto *searchable = dynamic_cast<ClutterSearchableI *>(parent);
...
void ClutterSearchableHelper::positionSearchBar(QWidget *parent, SearchBarWidget *searchBar,
